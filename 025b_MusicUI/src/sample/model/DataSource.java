...
public class DataSource {
  ...
  // make non-instantiable from outside
  private DataSource() {}
  ...
  public static DataSource getInstance() {
    // not thread safe as thread can be interrupted after null check
    // and another thread could instantiate another variable
    return instance;
  }
  ...
  public List<Album> queryAlbumsForArtistId(int artistId) {
    ...
    try {
      ...
      while (resultSet.next()) {
        result.add(new Album(resultSet.getInt("_id"), resultSet.getString("name"), artistId));
      }
